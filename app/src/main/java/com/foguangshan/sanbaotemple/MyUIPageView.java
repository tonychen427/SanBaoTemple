...
/**
 * Created by MacBookPro on 3/19/15.
 */
public class MyUIPageView extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.uipageviewer);
    ...
    private void setUiPageViewController() {
        ...
        dots[0].setTextColor(getResources().getColor(R.color.blue));
    }
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View view = layoutInflater.inflate(R.layout.fgs_banner_items, container, false);
