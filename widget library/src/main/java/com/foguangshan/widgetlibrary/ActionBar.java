package com.foguangshan.widgetlibrary;
...
public class ActionBar extends RelativeLayout implements OnClickListener {
    ...
    public void setImageDrawable(Drawable d){
        ...
        mHomeBtn.setImageDrawable(d);
        mHomeBtn.setTag(mTitleView.getText());

    }
    public void setHomeBtnClickListener(OnClickListener ClickListener){
...
//        mActionsView.setBackgroundColor(color);
     ...
     * @param action the action to add
     */
    public void addIconAction(Action action){
        final int index = mActionsView.getChildCount();
        mActionsView.addView(inflateAction(action,action.getIconicDrawable()),index);
    }
    /**
     * Adds a new {@link Action} at the specified index.
     * @param action the action to add
     ...
     * Inflates a {@link View} with the given {@link Action}.
     * @param action the action to inflate
     * @param drawable the iconic font to inflate
     * @return a view
     */
    private View inflateAction(Action action , Drawable drawable) {
        View view = mInflater.inflate(R.layout.actionbar_item, mActionsView, false);

        ImageButton labelView =
                (ImageButton) view.findViewById(R.id.actionbar_item);
        labelView.setImageDrawable(drawable);
        view.setTag(action);
        view.setOnClickListener(this);
        return view;
    }
    ...
    public static abstract class AbstractAction implements Action {
        ...
        final private Drawable mIconicDrawable;

        public AbstractAction(int drawable) {
            mDrawable = drawable;
            mIconicDrawable = null;
        }
        public AbstractAction(Drawable drawable) {
            mIconicDrawable = drawable;
            mDrawable = 0;
        }
        @Override
        public int getDrawable() {
