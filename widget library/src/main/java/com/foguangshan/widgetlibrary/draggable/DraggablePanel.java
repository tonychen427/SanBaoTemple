...
/**
 * Custom view created to handle com.foguangshan.widgetlibrary.draggable.DraggableView using fragments. With this custom view the client
...
public class DraggablePanel extends FrameLayout {
  ...
  /**
   * Configure the com.foguangshan.widgetlibrary.draggable.DraggableListener that is going to be invoked when the view be minimized,
  ...
  private void checkSupportFragmentManagerConsistency() {
    if (fragmentManager == null) {
      throw new IllegalStateException(
          "You have to set the support FragmentManager before initialize com.foguangshan.widgetlibrary.draggable.DraggablePanel");
    }
  }
  ...
  private void checkFragmentConsistency() {
    if (topFragment == null || bottomFragment == null) {
      throw new IllegalStateException(
          "You have to set top and bottom fragment before initialize com.foguangshan.widgetlibrary.draggable.DraggablePanel");
    }
  }
}
