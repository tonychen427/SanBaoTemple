package com.foguangshan.widgetlibrary.draggable;/*
...
import com.foguangshan.widgetlibrary.draggable.transformer.Transformer;
import com.foguangshan.widgetlibrary.draggable.transformer.TransformerFactory;

import com.foguangshan.widgetlibrary.R;
...
public class DraggableView extends RelativeLayout {
  ...
  /**
   * Configure the com.foguangshan.widgetlibrary.draggable.DraggableListener notified when the view is minimized, maximized, closed to the
  ...
  /**
   * Configure com.foguangshan.widgetlibrary.draggable.DraggableView to resize top view instead of scale it.
   */
   ...
   * FragmentManager is going to be provided only by com.foguangshan.widgetlibrary.draggable.DraggablePanel view.
   */
  ...
  /**
   * Notify te view is maximized to the com.foguangshan.widgetlibrary.draggable.DraggableListener
   */
  ...
  /**
   * Notify te view is minimized to the com.foguangshan.widgetlibrary.draggable.DraggableListener
   */
  ...
  /**
   * Notify te view is closed to the right to the com.foguangshan.widgetlibrary.draggable.DraggableListener
   */
  ...
  /**
   * Notify te view is closed to the left to the com.foguangshan.widgetlibrary.draggable.DraggableListener
   */
