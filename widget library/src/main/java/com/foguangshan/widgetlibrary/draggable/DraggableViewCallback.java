...
/**
 * ViewDragHelper.Callback implementation used to work with com.foguangshan.widgetlibrary.draggable.DraggableView to perform the scale
...
class DraggableViewCallback extends ViewDragHelper.Callback {
  ...
  /**
   * Maximize or minimize the com.foguangshan.widgetlibrary.draggable.DraggableView using the draggableView position and the y axis
   * velocity.
   */
